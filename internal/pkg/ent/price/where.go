...
func Cost(v uint16) predicate.Price {
	return predicate.Price(func(s *sql.Selector) {
...
func CostEQ(v uint16) predicate.Price {
	return predicate.Price(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldCost), v))
	})
}
...
func CostNEQ(v uint16) predicate.Price {
	return predicate.Price(func(s *sql.Selector) {
...
func CostIn(vs ...uint16) predicate.Price {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func CostNotIn(vs ...uint16) predicate.Price {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func CostGT(v uint16) predicate.Price {
	return predicate.Price(func(s *sql.Selector) {
...
func CostGTE(v uint16) predicate.Price {
	return predicate.Price(func(s *sql.Selector) {
...
func CostLT(v uint16) predicate.Price {
	return predicate.Price(func(s *sql.Selector) {
...
func CostLTE(v uint16) predicate.Price {
	return predicate.Price(func(s *sql.Selector) {
