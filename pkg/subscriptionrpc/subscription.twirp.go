...
/*
Package subscriptionrpc is a generated twirp stub package.
...
// ===================================
// SubscriptionService Protobuf Client
// ===================================
...
// NewSubscriptionServiceProtobufClient creates a Protobuf client that implements the SubscriptionService interface.
// It communicates using Protobuf and can be configured with a custom HTTPClient.
func NewSubscriptionServiceProtobufClient(addr string, client HTTPClient, opts ...twirp.ClientOption) SubscriptionService {
	...
	return &subscriptionServiceProtobufClient{
		client: client,
		urls:   urls,
		opts:   clientOpts,
	}
...
// ===============================
// SubscriptionService JSON Client
// ===============================
...
// NewSubscriptionServiceJSONClient creates a JSON client that implements the SubscriptionService interface.
// It communicates using JSON and can be configured with a custom HTTPClient.
func NewSubscriptionServiceJSONClient(addr string, client HTTPClient, opts ...twirp.ClientOption) SubscriptionService {
	if c, ok := client.(*http.Client); ok {
		client = withoutRedirects(c)
	}
	...
	return &subscriptionServiceJSONClient{
		client: client,
		urls:   urls,
		opts:   clientOpts,
	}
...
// ==================================
// SubscriptionService Server Handler
// ==================================
...
func NewSubscriptionServiceServer(svc SubscriptionService, hooks *twirp.ServerHooks) TwirpServer {
...
func (s *subscriptionServiceServer) writeError(ctx context.Context, resp http.ResponseWriter, err error) {
...
func (s *subscriptionServiceServer) serveStartSubscription(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	...
	case "application/json":
		s.serveStartSubscriptionJSON(ctx, resp, req)
	case "application/protobuf":
		s.serveStartSubscriptionProtobuf(ctx, resp, req)
	default:
...
func (s *subscriptionServiceServer) serveStartSubscriptionJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "StartSubscription")
	...
	func() {
		...
		respContent, err = s.SubscriptionService.StartSubscription(ctx, reqContent)
	}()
	...
	if respContent == nil {
		s.writeError(ctx, resp, twirp.InternalError("received a nil *Subscription and nil error while calling StartSubscription. nil responses are not supported"))
		return
	}
...
func (s *subscriptionServiceServer) serveStartSubscriptionProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "StartSubscription")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
func (s *subscriptionServiceServer) serveStopSubscription(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	header := req.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
	...
	switch strings.TrimSpace(strings.ToLower(header[:i])) {
	case "application/json":
		s.serveStopSubscriptionJSON(ctx, resp, req)
	case "application/protobuf":
		s.serveStopSubscriptionProtobuf(ctx, resp, req)
	default:
		msg := fmt.Sprintf("unexpected Content-Type: %q", req.Header.Get("Content-Type"))
		twerr := badRouteError(msg, req.Method, req.URL.Path)
		s.writeError(ctx, resp, twerr)
...
func (s *subscriptionServiceServer) serveStopSubscriptionJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "StopSubscription")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
	...
	reqContent := new(StopSubscriptionParams)
	unmarshaler := jsonpb.Unmarshaler{AllowUnknownFields: true}
	if err = unmarshaler.Unmarshal(req.Body, reqContent); err != nil {
		s.writeError(ctx, resp, malformedRequestError("the json request could not be decoded"))
		return
	...
	func() {
		defer ensurePanicResponses(ctx, resp, s.hooks)
		respContent, err = s.SubscriptionService.StopSubscription(ctx, reqContent)
	}()
...
func (s *subscriptionServiceServer) serveStopSubscriptionProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "StopSubscription")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
func (s *subscriptionServiceServer) serveGetSubscription(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	header := req.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
...
func (s *subscriptionServiceServer) serveGetSubscriptionJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "GetSubscription")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
	...
	reqContent := new(GetSubscriptionParams)
	unmarshaler := jsonpb.Unmarshaler{AllowUnknownFields: true}
	if err = unmarshaler.Unmarshal(req.Body, reqContent); err != nil {
		s.writeError(ctx, resp, malformedRequestError("the json request could not be decoded"))
		return
	...
	func() {
		defer ensurePanicResponses(ctx, resp, s.hooks)
		respContent, err = s.SubscriptionService.GetSubscription(ctx, reqContent)
	}()
	...
	if respContent == nil {
		s.writeError(ctx, resp, twirp.InternalError("received a nil *Subscription and nil error while calling GetSubscription. nil responses are not supported"))
		return
	}
...
func (s *subscriptionServiceServer) serveGetSubscriptionProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "GetSubscription")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
func (s *subscriptionServiceServer) serveGetSubscriptions(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	header := req.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
...
func (s *subscriptionServiceServer) serveGetSubscriptionsJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "GetSubscriptions")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
	...
	reqContent := new(GetSubscriptionsParams)
	unmarshaler := jsonpb.Unmarshaler{AllowUnknownFields: true}
	if err = unmarshaler.Unmarshal(req.Body, reqContent); err != nil {
		s.writeError(ctx, resp, malformedRequestError("the json request could not be decoded"))
		return
...
func (s *subscriptionServiceServer) serveGetSubscriptionsProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "GetSubscriptions")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
func (s *subscriptionServiceServer) ServiceDescriptor() ([]byte, int) {
	return twirpFileDescriptor0, 0
}

func (s *subscriptionServiceServer) ProtocGenTwirpVersion() string {
	return "v5.10.0"
}
